package org.jsmith.mvc.view
{
	 ...
	 */
	public class UIView extends UIComponent implements IView
	{
		/**
		 ...
		 * 	@inheritDoc
		 */
		public override function get id():String { return _id; }
		...
		public function UIView(id:String = null)
		{
			this.id = id;
